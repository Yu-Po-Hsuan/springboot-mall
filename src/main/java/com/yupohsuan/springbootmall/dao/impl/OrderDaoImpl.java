package com.yupohsuan.springbootmall.dao.impl;
...
import com.yupohsuan.springbootmall.rowmapper.OrderItemRowMapper;
import com.yupohsuan.springbootmall.rowmapper.OrderRowMapper;
import com.yupohsuan.springbootmall.rowmapper.ProductRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public List<OrderItem> getOrderItemsByOrderId(Integer orderId) {
        ...
        String sql = "SELECT oi.order_item_id, oi.order_id, oi.product_id, oi.quantity, oi.amount, " +
                "p.product_name, p.image_url FROM order_item as oi LEFT JOIN " +
